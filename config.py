...
telegram_bot_id = '921832076:AAH3omMltOvV8ehtDLcWbiZEWAVmwT4-sQ900'
...
miner_passw = 'root'
# #7)Укажите минимальный хэшрейт при котором асик отправляется на перезагрузку (по умолчанию 0Th\s)
minimal_hashrate = 0
