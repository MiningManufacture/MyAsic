...
Запуск мониторинга:
     ...
     где MyAsic-master папка с распакованным архивом или перейдите в папку с программой, правой кнопкой мыши нажмите на файл myasic.py и      выберите Открыть с помощью -> Python
